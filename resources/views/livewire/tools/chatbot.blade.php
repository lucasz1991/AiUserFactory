...
>
    <style>
        ...
        @media (min-width: 1140px) {
            ...
            body.workflow-copilot-docked > [data-app-main] {
                padding-right: 30rem;
                transition: padding-right 200ms ease;
            }
            body.workflow-copilot-docked > [data-app-topbar] {
                right: 30rem !important;
                transition: right 200ms ease;
            }
                            ...
                            <div class="space-y-3 p-4">
                                ...
                                <div class="flex flex-wrap gap-2 border-t border-slate-100 pt-3">
                                    ...
                                    @if(data_get($copilotStatus, 'active'))
                                        ...
                                        <button type="button" wire:click="terminateCopilotSession" wire:confirm="Copilot wirklich beenden und alle Node-Prozesse seiner Testlaeufe erzwungen schliessen?" wire:loading.attr="disabled" class="rounded-lg bg-rose-700 px-3 py-1.5 text-[11px] font-bold text-white hover:bg-rose-600 disabled:opacity-50">Beenden</button>
                                    @elseif($copilotNeedsAttention)
                                        ...
                                        <button type="button" wire:click="terminateCopilotSession" wire:confirm="Sitzung, Testlaeufe und alle zugeordneten Node-Prozesse erzwungen beenden?" wire:loading.attr="disabled" class="rounded-lg bg-rose-700 px-3 py-1.5 text-[11px] font-bold text-white hover:bg-rose-600 disabled:opacity-50">Alles beenden</button>
                                    @endif
                                </div>
                            </div>
                        </section>

        ...
        <div x-data="{ tab: 'overview' }" class="space-y-6">
            <div class="overflow-x-auto rounded-lg border border-gray-200 bg-white p-2 shadow-sm">
                <div class="flex min-w-max gap-2">
                    ...
                    <button type="button" @click="tab = 'processes'" :class="tab === 'processes' ? 'bg-slate-900 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'" class="rounded-md px-4 py-2 text-sm font-semibold">Prozesse</button>

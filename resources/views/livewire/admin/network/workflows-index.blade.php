<div class="space-y-6" wire:loading.class="opacity-60 pointer-events-none">
    ...
    <x-admin.panel title="Workflow-Gruppen">
        <div x-data="{ activeGroup: $persist(@entangle('activeGroup')) }" class="border-b border-slate-200 px-2">
        ...
        @if($subcategories->isNotEmpty())
            <div class="flex flex-wrap gap-2 border-b border-slate-100 py-3 px-2">

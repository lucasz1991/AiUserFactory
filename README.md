...
| --- | --- | --- | --- | --- | --- |
| 2026-07-27 | Codex | in_arbeit | UI/UX-Redesign fuer Workflow-Manager, gemeinsamen Testlauf/Run-Preview und Workflow-Chatbot. Ziel: ein konsistentes, ruhigeres Bedienkonzept mit Skiper-UI-inspirierten Bewegungs- und Oberflaechenmustern innerhalb des bestehenden Laravel-/Livewire-/Alpine-Stacks; keine neue zweite Vorschau und keine Aenderung der Runtime-Semantik. Bereich: Workflow-Manager-/Studio-/Run-Preview-Blades, Chatbot-Blade sowie eng zugehoerige Frontend-Styles und Markup-Tests. | In Arbeit. Geplant sind fokussierte UI-/Markup-Tests, Blade-Cache, Vite-Build, `prefers-reduced-motion`-/Tastatur-/Mobile-Pruefung und ein authentifizierter Browser-Smoke-Test. | Bestehende Oberflaechen und Interaktionen auditieren, gemeinsames Designsystem anwenden, anschliessend alle drei Flows visuell und funktional verifizieren. |

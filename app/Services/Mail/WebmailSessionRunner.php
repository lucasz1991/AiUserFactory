...
class WebmailSessionRunner
{
    ...
    public function start(array $account, string $scope = 'webmail', array $workflowContext = []): array
    {
        ...
        try {
            $timezone = $this->runtimeTimezone($runtime['timezone'] ?? $runtime['timeZone'] ?? null);
    ...
    public function cancelRun(?string $runId, bool $force = true, string $message = 'Webmail-Sessionlauf wurde abgebrochen.'): array
    {
        $runId = trim((string) $runId);
    ...
    protected function runtimeConfig(array $account, string $scope): array
    {
        ...
        return [
            ...
            'timezone' => $this->runtimeTimezone($account['timezone'] ?? $account['timeZone'] ?? null),
            'timeZone' => $this->runtimeTimezone($account['timezone'] ?? $account['timeZone'] ?? null),

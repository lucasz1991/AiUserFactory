    ...
    protected function mailRegistrationTasks(): array
    {
        return $this->hydrateTaskScripts([
            ...
            [
                ...
                'description' => 'Aus Persona-Name und Zufallswerten mehrere Mailadress-Kandidaten vorbereiten.',
                'kind' => 'data',
                'status' => 'automated',
                'input' => 'proton.me',
                'next' => ['card' => 'fill-mail-address', 'label' => 'Mailadresse eintragen'],
                'on_error' => ['step' => 'fail', 'label' => 'Keine Persona-Daten'],
            ],
            [
                'key' => 'fill-mail-address',
                'title' => 'Mailadresse eintragen',
                'description' => 'Aktuellen Wunsch-Username in das E-Mail-/Username-Feld eintragen.',
                'kind' => 'input',
                'status' => 'automated',
                'next' => ['card' => 'check-availability', 'label' => 'Verfuegbarkeit pruefen'],
                'on_error' => ['step' => 'fail', 'label' => 'Mailadress-Feld nicht gefunden'],
            ],
            [
            ...
            'fill-mail-address' => 'mail.fill_address',

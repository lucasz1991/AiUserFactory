    ...
    public function all(): array
    {
        return [
            ...
            'data.validate_inputs' => [
                ...
                'timeout_seconds' => 15,
                'description' => 'Prueft Start-/Eingabewerte wie ein bereits offenes Browserfenster, setzt optionale Defaults und leitet bei fehlenden Pflichtwerten ueber die Fehlerroute weiter.',
                'form' => [
                    'selector' => false,
                    'value' => false,
                    'url' => false,
                    ...
                    'extra_fields' => [
                        [
                            ...
                            'rows' => 8,
                            'span' => 'full',
                            'placeholder' => "[\n  {\"name\":\"browser_window\",\"source\":\"workflow_variables.browser_window\",\"type\":\"browser_window\",\"required\":true},\n  {\"name\":\"provider\",\"source\":\"account.provider\",\"required\":false,\"default\":\"proton\"}\n]\n\noder zeilenweise:\nbrowser_window=workflow_variables.browser_window|required|type:browser_window\nprovider=account.provider|optional|default:proton",
                            'help' => 'Mehrere Werte als JSON-Array/-Objekt oder zeilenweise name=quelle|required/optional|default:wert|type:browser_window. Pflichtwerte ohne Wert gehen auf die Fehlerroute.',
                            'tab' => 'Eingaben',
                        ],
                        [
                            'name' => 'output_group',

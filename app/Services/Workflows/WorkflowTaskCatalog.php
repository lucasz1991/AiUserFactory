    ...
    public function all(): array
    {
        ...
        $tasks = [
            ...
            'browser.open_browser_session' => [
                ...
                'browser_window' => 'main',
                'timeout_seconds' => 120,
                'description' => 'Interner Runtime-Task: Laedt die workflowweit konfigurierte Browser-Session. Wenn keine Session existiert, wird optional die Fallback-URL geoeffnet.',
                'form' => [
                    'browser_window' => true,
                    ...
                    'url' => true,
                    'url_label' => 'Fallback-URL (optional)',
                    'url_placeholder' => 'wird nur ohne gespeicherte Session geoeffnet',
            ...
            'browser.navigate_back' => [
                'label' => 'Zurueck navigieren',
                'kind' => 'browser',
                'runner' => 'node',
                'node_script' => 'node/workflows/tasks/browser/navigate_back.cjs',
                'timeout_seconds' => 30,
                'description' => 'Navigiert im aktiven Browserfenster einen Schritt zurueck in der Verlaufs-Historie.',
                'form' => [
                    'selector' => false,
                    'value' => false,
                    'url' => false,
            ...
            'browser.navigate_forward' => [
                'label' => 'Vorwaerts navigieren',
                'kind' => 'browser',
                'runner' => 'node',
                'node_script' => 'node/workflows/tasks/browser/navigate_forward.cjs',
                'timeout_seconds' => 30,
                'description' => 'Navigiert im aktiven Browserfenster einen Schritt vorwaerts in der Verlaufs-Historie.',
                'form' => [
                    'selector' => false,
                    'value' => false,
                    'url' => false,
            ...
            'browser.reload' => [
                ...
                'kind' => 'browser',
                'runner' => 'node',
                'node_script' => 'node/workflows/tasks/browser/reload.cjs',
                'timeout_seconds' => 60,
                'description' => 'Laedt die aktuelle Seite im aktiven Browserfenster neu und wartet auf den Abschluss der Navigation.',
                'form' => [
                    'selector' => false,
                    'value' => false,
                    'url' => false,
            ...
            'data.persist_browser_session' => [
                ...
                'browser_window' => 'main',
                'timeout_seconds' => 30,
                'description' => 'Interner Runtime-Task: Speichert Cookies und Browser-Storage automatisch anhand der Browser-Session-Einstellungen des Workflows.',
                'form' => [
                    'browser_window' => true,
                    'selector' => false,
                    'value' => false,

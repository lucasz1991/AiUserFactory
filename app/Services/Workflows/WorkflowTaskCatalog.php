                ...
                'form' => [
                    ...
                    'extra_fields' => [
                        [
                            ...
                            'rows' => 8,
                            'span' => 'full',
                            'placeholder' => "[\n  {\"name\":\"Mail-Inbox-Liste scannen.max_age_minutes\",\"source\":\"workflow_variables.mail_max_age\",\"required\":false,\"default\":2,\"type\":\"number\"},\n  {\"name\":\"Mail-Inbox-Liste scannen.subject_filter\",\"source\":\"workflow_variables.subject_filter\",\"required\":false},\n  {\"name\":\"browser_window\",\"source\":\"workflow_variables.browser_window\",\"type\":\"browser_window\",\"required\":true}\n]\n\noder zeilenweise:\nMail-Inbox-Liste scannen.max_age_minutes=workflow_variables.mail_max_age|optional|default:2|type:number\nMail-Inbox-Liste scannen.subject_filter=workflow_variables.subject_filter|optional",
                            'help' => 'name=quelle|required/optional|default:wert|type:number. Wenn der Name Tasktitel.inputid ist, wird dieser Wert in einem folgenden Task mit passendem Titel/Key ueberschrieben.',
                            'tab' => 'Eingaben',
                        ],
                        [
                            'name' => 'output_group',

...
class WorkflowStudioSession extends Model
{
    ...
    protected $fillable = [
        ...
        'workflow_copilot_session_id', 'mode', 'control_owner', 'mode_locked_at', 'permission_mode', 'status', 'goal',
    ...
    protected $casts = [
        ...
        'mode_locked_at' => 'datetime', 'started_at' => 'datetime', 'paused_at' => 'datetime', 'finished_at' => 'datetime', 'last_activity_at' => 'datetime',
    ];
